        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-auto">
            ...
            <input
              ...
              className="w-[300px] h-[50px] rounded-lg text-center text-[20px] font-league bg-[#EDEEEE] px-4 cursor-pointer"
            ...
            <select
              ...
              className="w-[300px] h-[50px] rounded-lg text-center text-[20px] font-league leading-relaxed bg-[#EDEEEE] px-4 cursor-pointer"
              aria-label="Set Time"
            >
            ...
            <select
              ...
              className={`w-[300px] h-[50px] rounded-lg text-center text-lg font-league leading-relaxed font-bold px-4 cursor-pointer  text-green bg-[#EDEEEE]  ${
                isOptionSelected ? 'focus:bg-green focus:text-white' : ''
              }`}
